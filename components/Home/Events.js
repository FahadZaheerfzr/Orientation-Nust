  ...
  return (
    <div className="my-12">
      ...
      <div className="flex md:flex-row flex-col bg-black mt-12 mx:0 xl:mx-48">
        <div className="flex flex-row md:flex-col ">
          {selectedEvent.activities.map((activity, i) => (
            <div
              ...
              key={i}
              className={`w-48 h-48 lg:w-64 flex-grow lg:h-64 cursor-pointer border-ultra-red ${
        ...
        <div
          className="w-full bg-tyrian-purple border-4 md:border-l-0 border-t-0 md:border-t-4 bg-cover border-ultra-red bg-no-repeat responsive"
          style={{
