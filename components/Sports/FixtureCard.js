...
const FixtureCard = ({ fixture, oneTeam, note, showType }) => {
  ...
  return (
    <Disclosure>
      <div className="flex flex-col p-2 dark:text-white text-[#121212] bg-white dark:bg-[#121212] rounded-lg my-4 border-2 dark:border-[#121212] border-white hover:border-ultra-red hover:cursor-pointer hover:border-2">
        <Disclosure.Button
          onClick={() => {
            setOpen(!open);
          }}
        ...
        >
          <Disclosure.Panel>
            <div className="dark:bg-tyrian-purple bg-ultra-red text-white dark:font-normal p-2 mt-2 rounded flex flex-col font-mont text-sm md:text-base lg:text-lg">
              ...
              {note && (
                <div className="flex">
                  <span className="font-montserrat">Note:</span> &nbsp;
                  {note}
                </div>
              )}
            </div>
