  ...
  return (
    <>
      <div
        ref={splashRef}
        style={{ height: "80vh" }}
        className={`flex justify-center items-center relative z-30 transition duration-500 ease-in-out ${
      ...
      <div
        ref={containerRef}
        className={`mt-24 transition-opacity duration-500 ease-in-out ${
          click ? "block" : "hidden"
        }`}
      >
